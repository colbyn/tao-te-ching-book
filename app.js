...
These three are superficial and aren't enough to keep us at the center of the circle, so we must also: Embrace simplicity. Put others first. Desire little.`],
...
"If you want to become whole, then first let yourself be broken," they weren't using empty words.
...
If you open yourself to Virtue, then you can become virtuous. If you open yourself to loss, then you will become lost.
If you open yourself to the Tao, the Tao will eagerly welcome you.
If you open yourself to virtue, virtue will become a part of you. If you open yourself to loss, the lost are glad to see you.
...
The Master does not thus she is able to The ordinary person will find that they force virtue on others, accomplish her task.
who uses force, accomplish nothing.
...
The moral person will act out of duty, and when no one responds will roll up his sleeves and uses force.
...
["Chapter 41",
`When a superior person hears of the Tao, She diligently puts it into practice.
When an average person hears of the Tao, he believes half of it, and doubts the other half.
When a foolish person hears of the Tao, he laughs out loud at the very idea.
If he didn't laugh, it wouldn't be the Tao.
Thus it is said: The brightness of the Tao seems like darkness, the advancement of the Tao seems like retreat, the level path seems rough, the superior path seems empty, the pure seems to be tarnished, and true virtue doesn't seem to be enough.
The virtue of caution seems like cowardice, the pure seems to be polluted, the true square seems to have no corners, the best vessels take the most time to finish, the greatest sounds cannot be heard, and the greatest image has no form.
...
The Master understands without leaving, sees clearly without looking, and accomplishes much without doing anything.`],
...
["Chapter 50",
`Those who leave the womb at birth and those who enter their source at death, of these; three out of ten celebrate life, three out of ten celebrate death, and three out of ten simply go from life to death.
...
The virtue of Tao in nature nurtures them, and their family gives them their form.
...
So the Tao gives them birth, and its virtue cultivates them, cares for them, nurtures them, gives them a place of refuge and peace, helps them to grow and shelters them.
...
When we know we are the Mother's children, we begin to guard the qualities of the Mother in us.
...
["Chapter 53",
`If I understood only one thing, I would want to use it to follow the Tao.
My only fear would be one of pride.
The Tao goes in the level places, but people prefer to take the short cuts.
...
The more weapons you posses, the greater the chaos in your country.
The more knowledge that is acquired, the stranger the world will become. The more laws that you make, the greater the number of criminals.
Therefore the Master says:
I do nothing, and people become good by themselves.
I seek peace, and people take care of their own problems. I do not meddle in their personal lives, and the people become prosperous.
...
Those who use moderation are already on the path to the Tao.
...
["Chapter 67",
`The world talks about but you can't tell it Because it is thought the world makes light It seems too easy for

honoring the Tao, from their actions. of as great, of it. anyone to use.
...
To abandon compassion while seeking to be brave, or abandoning moderation while being benevolent,
or abandoning humility while seeking to lead will only lead to greater trouble.
...
Yet no one in the world seems to understand them, and is not able to apply what I teach.
...
["Chapter 73",
`Being overbold and confident is deadly.
...
["Chapter 77",
`The Tao of Heaven works in like the drawing of a bow. The top is bent downward; the bottom is bent up.
The excess is taken from, and the deficient is given overcome.
the world to.
...
function toUrlSafeString(value) {
...
function onLoad() {
    ...
    for ([heading_txt, body_txt] of TEXT) {
        sectionCounter += 1;
        ...
        const heading_inner = document.createElement('a');

        heading.setAttribute('id', sectionId);
        heading_inner.setAttribute('href', `#${sectionId}`);
        
        heading_inner.innerText = heading_txt;
        heading.appendChild(heading_inner);
